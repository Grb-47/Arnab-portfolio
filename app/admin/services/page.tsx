...
const categories = ["graphics", "video", "photography", "research"] as const;
        ...
        <div key={cat} className="mt-6">
          ...
          {data[cat].map((item, i) => (
            <div key={i} className="p-3 border border-gray-700 rounded mb-2 bg-gray-900">
              ...
              <Field label="Description" val={item.description} onChange={(v) => updateItem(cat, i, "description", v)} />
              <Field label="Link" val={item.link} onChange={(v) => updateItem(cat, i, "link", v)} />
